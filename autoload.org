  ...
  (-if-let* ((bookmarks
              (or bookmarks-list
                  (-some->> (doom-project-root)
                    ((lambda (x) (f-join x "bookmarks.json")))
                    (-id-when #'f-exists?)
                    (json-read-file))))
