...
(defun +org|counsel-org-tag ()
  ...
  (interactive)
  (let* ((org-current-tag-alist org-tag-persistent-alist)
         (org-complete-tags-always-offer-all-agenda-tags t)
         (org-current-tag-alist (append org-current-tag-alist (list (org-get-tags)))))
    (counsel-org-tag)))

(defun +org|counsel-org-tag-agenda ()
  "Set tags for the current agenda item."
  (interactive)
  (cl-letf (((symbol-function 'org-set-tags-command) #'+org|counsel-org-tag))
      (org-agenda-set-tags)))
#+END_SRC
