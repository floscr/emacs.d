...
Copy from [[file:~/.emacs.d/modules/lang/org/autoload/org-capture.el::defun +org-capture/open-frame (&optional initial-input key][org-capture.el]] adapted to my needs.
