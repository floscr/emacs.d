...
(after! org
  ...
  ;; Disable automatic line wrapping in org mode
...
(+org/add-to-agenda-custom-commands
 '("w" "Work Agenda"
   ((agenda "a" ((org-agenda-skip-scheduled-if-done t)
                 (org-agenda-sorting-strategy '(todo-state-up deadline-up user-defined-down timestamp-down time-down))
                 (org-agenda-span 3)
...
(map! :after evil-org-agenda
      ...
      (:prefix-map ("w" . "Refile")
        ...
        :desc "To Reading List"    "r" (λ! (+org/agenda-refile "reading-list.org" "Reading List"))
        :desc "To shoppping list"  "s" (λ! (+org/agenda-refile "shoppinglist.org" "Supermarket"))
