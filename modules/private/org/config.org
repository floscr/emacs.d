...
(setq
 ...
 org-default-notes-file (concat org-directory "/Main/inbox.org")
 org-shopping-list-file (concat org-directory "/Main/shoppinglist.org"))
  ...
  (setq org-capture-templates
        `(("t" "todo" entry
          ...
          ("c" "Calendar Event" entry
           (file+headline ,(concat org-directory "/Main/gtd.org") "Calendar")
           "* %?\n")

          ("e" "Emacs Todo" entry
           (file+headline ,(concat org-directory "/Main/emacs.org") "Emacs Todos")
           "* TODO %?\n")
...
(defun +org-my-init-agenda-keybinds-h ()
  (map! :after org-agenda
        ...
        (:prefix ("w" . "Refile")
          ...
          :desc "To Work"            "W" (λ! (+org/agenda-refile "work.org" "Work Todos")))))
