...
(map! :map org-mode-map
      ...
      (:prefix-map ("y" . "Yank")
       :desc "Link" "l" (cmd! (+my/copy-message (+org|link-from-point)))
       :desc "Url" "u" (cmd! (+my/copy-message (+org|link-url-from-point)))
       :desc "Title" "t" (cmd! (+my/copy-message (+org|link-title-from-point))))
...
(map! :after org-agenda
      ...
      (:prefix ("w" . "Refile")
       ...
       :desc "To GTD Backlog"     "b" (cmd! (+org/agenda-refile "Main/gtd.org" "GTD Backlog"))
