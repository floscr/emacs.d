         ...
         (alternate-file
          (-some-->
              (or
               ...
               ;; Canvas defaultProps file
               (-some--> (s-contains? "defaultProps" file-name)
                 (s-split "\\." file-name)
                 (car it)
                 (concat it ".js"))
               ;; Canvas defaultProps alternate file
               (-some--> (f-no-ext file-name)
                 (concat it ".defaultProps.js")
                 (when (f-exists? (f-join file-dir-path it)) it)))
